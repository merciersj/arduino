...
unsigned char note[MELODY_LENGTH] = 
{
  ...
  SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE,
  SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE,
  SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE,
  SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE, SILENT_NOTE
};
...
void playMelody() {
  ...
  if (counter < MELODY_LENGTH && !buzzer.isPlaying())
  {
    // play note at max volume
    buzzer.playNote(note[counter], duration[counter], 15);
    
    counter++;
    counter = counter%MELODY_LENGTH;
  }
}
...
void resetMelody() {
  ...
  if (OrangutanPushbuttons::isPressed(TOP_BUTTON))
  {
    ...
    if (counter < MELODY_LENGTH)
      counter = MELODY_LENGTH;        // terminate the melody
    else
      counter = 0;                    // restart the melody
    OrangutanPushbuttons::waitForRelease(TOP_BUTTON);  // wait here for the button to be released
  }
}
